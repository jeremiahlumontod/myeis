package org.jml.myeis.fixedassetdisposal;
...
public class fixedassetdisposalTest2 {
    ...
    public void runTest2() throws Exception {
        ...
        //for(int i = 0; i < tasks.size(); i++) {
            ...
            com.cbody.usertypeType usertype = nextstep.usertype.append();
            usertype.setValue("user");
            com.cbody.usercodeType usercode = nextstep.usercode.append();
            usercode.setValue("jml");
        ...
        do {
            ...
            usertype = nextstep.usertype.append();
            usertype.setValue("user");
            usercode = nextstep.usercode.append();
            usercode.setValue("jml");
